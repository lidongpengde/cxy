...
;(function ($, window) {
    ...
    function _buildList(list, data) {
        ...
        for (var item = 0, count = list.length; item < count; item++) {
            ...
            label = data.highlightMatches ? name.replace(highlightReg, "<strong>$&</strong>") : name;
        ...
        if (list.length && data.hint) {
            var hint = ( list[0].name.substr(0, data.query.length).toUpperCase() === data.query.toUpperCase() ) ? list[0].name : false;
